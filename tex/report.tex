...
We conclude that neither optimality nor stability is the best property for making the matching. The algorithm you should choose should always depend on the data and your preferences.
